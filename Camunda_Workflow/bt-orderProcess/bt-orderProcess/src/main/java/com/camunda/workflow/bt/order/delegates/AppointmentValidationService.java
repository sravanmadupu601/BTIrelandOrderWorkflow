...
@Component(value = "appointmentValidation")
public class AppointmentValidationService implements JavaDelegate {
    @Override
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        String valid_status = rootobj.get("GREEN").getAsString();
